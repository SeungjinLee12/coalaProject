...
const Menu = React.forwardRef(function Menu(props, ref) {
  const { children, currentUser, ...other } = props;
  ...
  return (
    <React.Fragment>
      <DropdownContext.Provider value={dropdownContextValue}>
        ...
        <Menu id="hooks-menu">
          <MenuItem onClick={createHandleMenuClick("information")}>
            회원정보수정
          </MenuItem>
          <MenuItem onClick={createHandleMenuClick("password")}>
            비밀번호변경
          </MenuItem>
          <MenuItem onClick={createHandleMenuClick("interest")}>
            관심분야변경
          </MenuItem>
          <MenuItem onClick={createHandleMenuClick("cart")}>장바구니</MenuItem>
          <MenuItem onClick={createHandleMenuClick("payment")}>
            결제내역
          </MenuItem>
          <MenuItem onClick={createHandleMenuClick("LogOut")}>LogOut</MenuItem>
          {currentUser.TYPE === 2 && ( // currentUser.TYPE이 2일 때만 렌더링
            <MenuItem onClick={createHandleMenuClick("manage")}>
              Management
            </MenuItem>
          )}
        </Menu>
